...
interface ViewUtils {
    ...
    val View.w:Int get() = this.width
    val View.h:Int get() = this.height
...
//        }, 1)
    ...
    class ViewPagerAdapter(val mViewList: List<View>) : PagerAdapter() {

        override fun getCount(): Int {//必须实现
            return mViewList.size
        }

        override fun isViewFromObject(view: View, `object`: Any): Boolean {//必须实现
            return view === `object`
        }
